...
public class ContractDetails {
  ...
  public String aquisitionStateMemberUE;
  ...
  public void setFrameworkAgreementProcedureDescription(
      String frameworkAgreementProcedureDescription) {
  ...
  public ContractDetails setCpvsValue(String cpvsValue) {
    ...
    public ContractDetails setCpvsType(String cpvsType) {
  ...
  public ContractDetails setCpvsDesignation(String cpvsDesignation) {
  ...
  public ContractDetails setGroupMembers(String[] groupMembers) {
    this.groupMembers = groupMembers;
    return this;
  }

  public String getAquisitionStateMemberUE() {
    return aquisitionStateMemberUE;
  }

  public ContractDetails setAquisitionStateMemberUE(String aquisitionStateMemberUE) {
  ...
  public ContractDetails setInfoAquisitionStateMemberUE(
      String infoAquisitionStateMemberUE) {
